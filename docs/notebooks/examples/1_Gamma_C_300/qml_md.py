...
if __name__ == "__main__":
    ...
    dbfile = sys.argv[1]
    atoms = molecule('H2O')
    qmmodel = db2qmmodel(dbfile, names = '*', mmodels=models, target='gamma2c', method='gamma2c',purify_gamma=True)
    #
    atoms.calc = QMLCalculator(qmmodel = qmmodel, method = 'gamma2', properties=('energy'))
